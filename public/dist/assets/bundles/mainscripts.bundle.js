...
function skinChanger() {
    $(".choose-skin li").on("click", function() {
        ...
        $(".choose-skin li").removeClass("active"), e.removeClass("theme-" + n), t.addClass("active"), e.addClass("theme-" + t.data("theme"))
    })
}
$(function() {
    "use strict";
    ...
    $(".sidebar").metisMenu(), $(".btn-toggle-fullwidth").on("click", function() {
...
function switchTheme(e) {
    e.target.checked ? (document.documentElement.setAttribute("data-theme", "dark"), localStorage.setItem("theme", "dark"), $('.theme-high-contrast input[type="checkbox"]').prop("checked", !1)) : (document.documentElement.setAttribute("data-theme", "light"), localStorage.setItem("theme", "light"))
}

function switchHc(e) {
    e.target.checked ? (document.documentElement.setAttribute("data-theme", "high-contrast"), localStorage.setItem("theme", "high-contrast"), $('.theme-switch input[type="checkbox"]').prop("checked", !1)) : (document.documentElement.setAttribute("data-theme", "light"), localStorage.setItem("theme", "light"))
}
currentTheme && (document.documentElement.setAttribute("data-theme", currentTheme), "dark" === currentTheme && (toggleSwitch.checked = !0), "high-contrast" === currentTheme && (toggleHcSwitch.checked = !0, toggleSwitch.checked = !1)), toggleSwitch.addEventListener("change", switchTheme, !1), toggleHcSwitch.addEventListener("change", switchHc, !1), $.fn.clickToggle = function(t, n) {
