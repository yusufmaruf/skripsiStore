                ...
                <div class="header">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <h2>Pegawai<small>Berikut Merupakan Informasi data pegawai anda</small> </h2>

                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="d-flex flex-row-reverse">

                                <a href="{{ route('pegawai.create') }}" class="btn btn-primary mt-2"><i class="fa fa-plus">
                                    </i> Tambah
                                    pegawai</a>
                            </div>
                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group d-flex justify-content-around" role="group"
                                            ...
                                            <a href="{{ route('pegawai.edit', ['pegawai' => 1]) }}"
